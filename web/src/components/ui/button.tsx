...
const buttonVariants = cva(
  'inline-flex touch-manipulation items-center justify-center rounded-full text-lg font-normal focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
